...
for (i in c(3, ceiling(funcnum/2), funcnum)) { #loop over all subsets of function of size 1:funcnum
...
for (i in c(3, ceiling(specnum/2), specnum)) { #loop over all subsets of function of size 1:funcnum
