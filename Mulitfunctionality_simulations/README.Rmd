...
+ This script produces **Figure_4** (for method `Biodepth_data`)

+ This script produces **Figure_S1** (for method `Single_dist`)

###Explanation_of_slope_pattern.Rmd
This [this script](Explanation_of_slope_pattern.Rmd) up the simulations to explain the link between the distribution of function values across species, the slopes and the multithreshold approach. This figure and the accompanying text is not part of the final publication but is now part of the shiny app. 
