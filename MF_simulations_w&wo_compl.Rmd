...
+ `comp` for complementary. Here one, several or all functions are multiplied with a complementary factor before the average is calculated. The complementary factor is always a saturating  function of the richness level of the form:
...
$$ compfac = CF * ( 1 - ( 1 - \frac{1}{CF} ) * exp{ ( 1 - Richness ^ r )} $$
  ...
  + `compfunc` : the functions subjected to complementary. Either "all" or a subset of `func.names`
