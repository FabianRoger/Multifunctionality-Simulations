...
+ `Biodepth_data`:
The monoculture data from the BIODEPTH experiment (included in the `multifunc` package) are used to simulate the null-expectation for the multithreshold approach. **Choosing Germany produces Figure 4**
...
Multi_dist <- FALSE
Biodepth_data <- FALSE #produces Figure 4
Biodepth_sim <- FALSE
...
if(Biodepth_data) {
  ggsave("Figure_4.pdf", plot, height = 6, width = 10)
}
