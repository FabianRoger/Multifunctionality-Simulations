...
**note that the distribution is irrelevant here, as the values will be replaced by correlated function values**
...
Figure_S2 <- plot_grid(SingleFunc, SingleFunc_comp,
...
ggsave( "Figure_S2.pdf", Figure_S2, height = 20, width = 14, device=cairo_pdf)
