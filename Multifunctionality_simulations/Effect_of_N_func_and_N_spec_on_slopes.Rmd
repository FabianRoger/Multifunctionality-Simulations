...
(see `Effect on averaging approach` below for Figure 3 a)
...
**Choosing the pre-set values produces Figure 3a** which shows the relationship of the slope with number of functions. Figure 3 includes scenarios with 0 , 3, 6 and 9 (all) functions subjected to complementary. 
...
plot
ggsave("Figure_3.pdf", plot, height = 4, width = 10)
